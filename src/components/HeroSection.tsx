    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-200/20 to-transparent w-full h-1 animate-[scan_3s_ease-in-out_infinite] top-1/4"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-indigo-200/15 to-transparent w-full h-2 animate-[scan_4s_ease-in-out_infinite_1s] top-2/3"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-300/10 to-transparent w-full h-1 animate-[scan_5s_ease-in-out_infinite_2s] top-1/2"></div>
        </div>
        
        {/* Grid pattern overlay */}
        <div className="absolute inset-0 opacity-30">
          <div className="w-full h-full" style={{
            backgroundImage: `url("data:image/svg+xml,%3csvg width='40' height='40' xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3cpattern id='grid' width='40' height='40' patternUnits='userSpaceOnUse'%3e%3cpath d='m 40 0 l 0 0 0 40' fill='none' stroke='%233B82F6' stroke-width='0.5' opacity='0.3'/%3e%3c/pattern%3e%3c/defs%3e%3crect width='100%25' height='100%25' fill='url(%23grid)'/%3e%3c/svg%3e")`,
          }} />
        </div>
        
        {/* Subtle floating elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-32 h-32 bg-blue-200/20 rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
          <div className="absolute bottom-40 right-20 w-24 h-24 bg-indigo-200/25 rounded-full mix-blend-multiply filter blur-lg animate-bounce"></div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Visual metaphor with consistent colors */}
          <div className="flex justify-center items-center gap-12 md:gap-20">
            <div className="text-center group">
              <div className="relative">
                <div className="w-24 h-24 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg">
            ...
            <div className="text-center group">
              <div className="relative">
                <div className="w-24 h-24 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-2xl flex items-center justify-center mb-6 mx-auto shadow-lg">
                  <TrendingUp className="w-8 h-8 text-indigo-600" />
                </div>
                <div className="absolute -top-2 -right-2 w-6 h-6 bg-indigo-600 rounded-full flex items-center justify-center animate-pulse">
