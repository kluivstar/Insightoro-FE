  ...
  return (
    <section className="py-24 bg-gradient-to-br from-slate-50 to-blue-50/30 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.02]">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHZpZXdCb3g9IjAgMCA0MCA0MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48ZyBmaWxsPSJub25lIiBmaWxsLXJ1bGU9ImV2ZW5vZGQiPjxnIGZpbGw9IiMzQjgyRjYiPjxjaXJjbGUgY3g9IjIwIiBjeT0iMjAiIHI9IjEiLz48L2c+PC9nPjwvc3ZnPg==')] opacity-40"></div>
      </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                {/* Inner pulse ring */}
                <div className="absolute inset-2 w-16 h-16 bg-gradient-to-r from-blue-600/10 to-indigo-600/10 rounded-full animate-pulse delay-150"></div>
                
                {/* Main arrow container */}
                <div className="relative w-20 h-20 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center shadow-2xl transform hover:scale-105 transition-transform duration-300">
                  <ArrowRight className="w-10 h-10 text-white animate-[bounce_1s_ease-in-out_infinite] transform translate-x-0.5" />
                </div>
                
                {/* Scanning effect */}
                <div className="absolute inset-0 w-20 h-20 rounded-full overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent w-full h-full animate-[scan_2s_linear_infinite] transform -skew-x-12"></div>
                </div>
              </div>
            </div>
