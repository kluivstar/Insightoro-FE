      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
          {steps.map((step, index) => (
            <div key={index} className="bg-white border-2 border-gray-300 p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
              {/* Image first */}
              <div className="mb-6">
                <div className="relative w-full h-48 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100/50 p-4">
                  {step.mockupContent}
                </div>
              </div>
