          ...
          <div className="max-w-7xl mx-auto animate-fade-in">
            ...
            <div className="relative bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden">
              ...
              <div className="p-6 md:p-10">
                {/* Screenshot Section */}
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/60 p-8 mb-8">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg">
                      <Monitor className="w-6 h-6 text-white" />
                    </div>
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">Scanned Page</h3>
                      <p className="text-gray-600">Here's how your page appears to visitors</p>
                    </div>
                  </div>
                  
                  <div className="bg-gray-50/80 backdrop-blur-sm rounded-xl border border-gray-200/50 p-6">
                    <div className="bg-white rounded-lg border-2 border-gray-300 overflow-hidden shadow-lg">
                      <div className="bg-gray-100 px-4 py-2 flex items-center gap-2 border-b">
                        ...
                        <div className="text-xs text-gray-500 ml-2">https://yourwebsite.com</div>
                      </div>
                      <img 
                        ...
                        alt="Screenshot of scanned website showing monitor with programming code"
                        className="w-full h-64 object-cover"
                      />
                    </div>
                    <div className="mt-4 flex items-center gap-2 text-sm text-gray-600">
                      <Activity className="w-4 h-4" />
                      <span>Captured: Desktop view • 1920x1080 resolution</span>
                    </div>
                  </div>
                </div>
